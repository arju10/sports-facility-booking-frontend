  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex w-full flex-col justify-center px-4 py-12 lg:w-1/2 lg:px-8">
        ...
        >
          ...
          <div className="mt-6 rounded-lg bg-muted p-4 text-xs">
            ...
            <p className="text-muted-foreground">👤 User: john@example.com / password123</p>
      ...
      <div className="hidden lg:block lg:w-1/2">
        <div className="relative h-full w-full">
          <img
            src="https://images.unsplash.com/photo-1461896836934-ffe607ba8211?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80"
            alt="Sports"
            className="h-full w-full object-cover"
            onError={(e) => {
              e.currentTarget.src = 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80';
